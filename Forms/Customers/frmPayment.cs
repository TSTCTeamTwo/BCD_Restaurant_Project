    ...
    public partial class frmPayment : Form {
        ...
        private void btnAdd_Click(object sender, EventArgs e) {
            if (rdoPaymentOptionCard.Checked)
                ProgOps.addPayment(mskPaymentNumber.Text, "Credit", tbxName.Text, mskSecurityCode.Text,
                                   mskExpirationDate);
            else if (rdoPaymentOptiondebit.Checked)
                ProgOps.addPayment(mskPaymentNumber.Text, "Debit", tbxName.Text, mskSecurityCode.Text,
                                   mskExpirationDate);
        }
